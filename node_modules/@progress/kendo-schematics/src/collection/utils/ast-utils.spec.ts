...
describe('ast utils', () => {
    describe('insert import', () => {
        ...
        it('should import, other import declarations', () => {
            const content = `
        ...
        it('should import, no other import declarations', () => {
            const content = '';
    ...
    describe('module meta', () => {
        ...
        it('should return a node when NgModel decorator is imported as alias', () => {
            const content = `
